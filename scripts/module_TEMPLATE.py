...
def process_device(device_name, username, decrypted_password, group_name, device_type):
    ...
    try:
        ...
        """
        values = (datetime.now(), backup_info['device_name'], backup_info['site_name'], backup_info['type'], backup_info['username'], exit_status, config_file_path)
        ...
        insert_query = """
            ...
            VALUES (%s, %s, %s, %s, %s, %s, %s)
        """
        values = (datetime.now(), backup_info['device_name'], backup_info['site_name'], backup_info['type'], backup_info['username'], exit_status, 'NA')
...
# Example usage
# process_device(device_name, username, decrypted_password, group_name)
